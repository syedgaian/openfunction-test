...
var logging_Logging_pb = require('../logging/Logging_pb.js');
...
function serialize_skywalking_v3_LogData(arg) {
  if (!(arg instanceof logging_Logging_pb.LogData)) {
    throw new Error('Expected argument of type skywalking.v3.LogData');
  }
  return Buffer.from(arg.serializeBinary());
}

function deserialize_skywalking_v3_LogData(buffer_arg) {
  return logging_Logging_pb.LogData.deserializeBinary(new Uint8Array(buffer_arg));
}


// Report collected logs into the OAP backend
var LogReportServiceService = exports.LogReportServiceService = {
...
collect: {
    ...
    requestType: logging_Logging_pb.LogData,
    responseType: common_Common_pb.Commands,
    requestSerialize: serialize_skywalking_v3_LogData,
    requestDeserialize: deserialize_skywalking_v3_LogData,
    responseSerialize: serialize_skywalking_v3_Commands,
    responseDeserialize: deserialize_skywalking_v3_Commands,
  },
};

exports.LogReportServiceClient = grpc.makeGenericClientConstructor(LogReportServiceService);
