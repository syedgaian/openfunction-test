...
var language$agent_JVMMetric_pb = require('../language-agent/JVMMetric_pb.js');
...
function serialize_skywalking_v3_JVMMetricCollection(arg) {
  if (!(arg instanceof language$agent_JVMMetric_pb.JVMMetricCollection)) {
    throw new Error('Expected argument of type skywalking.v3.JVMMetricCollection');
  }
  return Buffer.from(arg.serializeBinary());
}

function deserialize_skywalking_v3_JVMMetricCollection(buffer_arg) {
  return language$agent_JVMMetric_pb.JVMMetricCollection.deserializeBinary(new Uint8Array(buffer_arg));
}
...
var JVMMetricReportServiceService = exports.JVMMetricReportServiceService = {
  collect: {
    ...
    requestType: language$agent_JVMMetric_pb.JVMMetricCollection,
    responseType: common_Common_pb.Commands,
    requestSerialize: serialize_skywalking_v3_JVMMetricCollection,
    requestDeserialize: deserialize_skywalking_v3_JVMMetricCollection,
