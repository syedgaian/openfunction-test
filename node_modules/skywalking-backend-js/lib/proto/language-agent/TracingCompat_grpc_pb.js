...
function serialize_skywalking_v3_SegmentCollection(arg) {
  if (!(arg instanceof language$agent_Tracing_pb.SegmentCollection)) {
    throw new Error('Expected argument of type skywalking.v3.SegmentCollection');
  }
  return Buffer.from(arg.serializeBinary());
}

function deserialize_skywalking_v3_SegmentCollection(buffer_arg) {
  return language$agent_Tracing_pb.SegmentCollection.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_skywalking_v3_SegmentObject(arg) {
...
function deserialize_skywalking_v3_SegmentObject(buffer_arg) {
...
collect: {
    ...
    requestSerialize: serialize_skywalking_v3_SegmentObject,
    requestDeserialize: deserialize_skywalking_v3_SegmentObject,
...
collectInSync: {
    path: '/TraceSegmentReportService/collectInSync',
    requestStream: false,
    responseStream: false,
    requestType: language$agent_Tracing_pb.SegmentCollection,
    responseType: common_Common_pb.Commands,
    requestSerialize: serialize_skywalking_v3_SegmentCollection,
    requestDeserialize: deserialize_skywalking_v3_SegmentCollection,
    responseSerialize: serialize_skywalking_v3_Commands,
    responseDeserialize: deserialize_skywalking_v3_Commands,
  },
};
