...
const runtime_1 = require("./openfunction/runtime");
 ...
 */
const wrapOpenFunction = (userFunction, context) => {
    const ctx = runtime_1.OpenFunctionRuntime.ProxyContext(context);
    const wrapper = runtime_1.OpenFunctionRuntime.WrapUserFunction(userFunction, ctx);
 ...
 * @return An Express hander function that invokes the user function.
 */
const wrapUserFunction = (userFunction, signatureType, context) => {
    switch (signatureType) {
        case 'http':
            return wrapHttpFunction(userFunction);
        case 'openfunction':
            return wrapOpenFunction(userFunction, context);
        case 'event':
