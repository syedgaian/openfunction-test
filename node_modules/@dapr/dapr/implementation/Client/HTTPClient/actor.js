...
class HTTPClientActor {
    ...
    create(actorTypeClass) {
        const builder = new ActorProxyBuilder_1.default(actorTypeClass, this.client.getClientHost(), this.client.getClientPort(), this.client.getClientCommunicationProtocol(), this.client.getOptions());
        const actor = builder.build(ActorId_1.default.createRandomId());
        return actor;
    }
}
exports.default = HTTPClientActor;
